...
export function Explore({ domainId, domainName, onUnauthorized }: Props) {
  ...
  useEffect(() => {
    ...
    getDomainExplore(domainId, days)
      .then(({ sources: s }) => { if (!cancelled) setSources(s); })
      .catch((e) => {
        if (cancelled) return;
      ...
      <div style={s.pageHeader}>
        ...
        <div style={s.controls}>
          ...
          <div style={s.pills}>
            ...
            <button
              style={{ ...s.pill, ...(filter === 'anomalies' ? s.pillActiveDanger : {}) }}
        ...
        <div style={s.emptyState}>
          ...
          <div style={s.emptyTitle}>
            {filter === 'anomalies'
              ...
              : `No sources in the last ${days} days`}
          </div>
          <div style={s.emptyHint}>
            {filter === 'anomalies'
              ? 'All sending sources are passing DMARC.'
